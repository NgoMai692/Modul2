    ...
    public static String getScore(String player1Name, String player2Name, int firstScore, int secondScore) {
        ...
        if (compareScore)
        {
            ...
            if (isOneOfScoreMoreThan4)
            {
                ...
                boolean isFirstCoreAdvantage = minusResult == 1;
                if (isFirstCoreAdvantage) score ="Advantage player1";
                else {
            ...
            {
                score = getScore(firstScore, secondScore, score);
            }
        }
        return score;
    }

    private static String getScore(int firstScore, int secondScore, String score) {
        int tempScore;
        for (int i = 1; i<3; i++)
        {
